...
typedef struct wire_cst_lwk_wallet {
  uintptr_t inner;
} wire_cst_lwk_wallet;
...
void frbgen_lwk_dart_wire_lwk_wallet_address(int64_t port_,
                                             struct wire_cst_lwk_wallet *that,
                                             uint32_t index);

void frbgen_lwk_dart_wire_lwk_wallet_address_last_unused(int64_t port_,
                                                         struct wire_cst_lwk_wallet *that);

void frbgen_lwk_dart_wire_lwk_wallet_balances(int64_t port_, struct wire_cst_lwk_wallet *that);

void frbgen_lwk_dart_wire_lwk_wallet_blinding_key(int64_t port_, struct wire_cst_lwk_wallet *that);

void frbgen_lwk_dart_wire_lwk_wallet_broadcast_tx(int64_t port_,
                                                  struct wire_cst_list_prim_u_8_strict *electrum_url,
                                                  struct wire_cst_list_prim_u_8_loose *tx_bytes);

void frbgen_lwk_dart_wire_lwk_wallet_build_asset_tx(int64_t port_,
                                                    struct wire_cst_lwk_wallet *that,
                                                    uint64_t sats,
...
void frbgen_lwk_dart_wire_lwk_wallet_build_lbtc_tx(int64_t port_,
                                                   struct wire_cst_lwk_wallet *that,
                                                   uint64_t sats,
                                                   struct wire_cst_list_prim_u_8_strict *out_address,
                                                   float abs_fee);

void frbgen_lwk_dart_wire_lwk_wallet_decode_tx(int64_t port_,
                                               struct wire_cst_lwk_wallet *that,
                                               struct wire_cst_list_prim_u_8_strict *pset);

void frbgen_lwk_dart_wire_lwk_wallet_descriptor(int64_t port_, struct wire_cst_lwk_wallet *that);

void frbgen_lwk_dart_wire_lwk_wallet_init(int64_t port_,
                                          int32_t network,
                                          struct wire_cst_list_prim_u_8_strict *dbpath,
                                          struct wire_cst_descriptor *descriptor);

void frbgen_lwk_dart_wire_lwk_wallet_sign_tx(int64_t port_,
                                             struct wire_cst_lwk_wallet *that,
                                             int32_t network,
                                             struct wire_cst_list_prim_u_8_strict *pset,
                                             struct wire_cst_list_prim_u_8_strict *mnemonic);

void frbgen_lwk_dart_wire_lwk_wallet_sync(int64_t port_,
                                          struct wire_cst_lwk_wallet *that,
                                          struct wire_cst_list_prim_u_8_strict *electrum_url);

void frbgen_lwk_dart_wire_lwk_wallet_txs(int64_t port_, struct wire_cst_lwk_wallet *that);
...
struct wire_cst_lwk_wallet *frbgen_lwk_dart_cst_new_box_autoadd_lwk_wallet(void);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_cst_new_box_autoadd_lwk_wallet);
    ...
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_address);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_address_last_unused);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_balances);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_blinding_key);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_broadcast_tx);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_build_asset_tx);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_build_lbtc_tx);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_decode_tx);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_descriptor);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_init);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_sign_tx);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_sync);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire_lwk_wallet_txs);
