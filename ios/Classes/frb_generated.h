...
WireSyncRust2DartDco frbgen_lwk_dart_wire__crate__api__types__AssetIdBTreeMapInt_auto_accessor_get_field0(uintptr_t that);

WireSyncRust2DartDco frbgen_lwk_dart_wire__crate__api__types__AssetIdBTreeMapInt_auto_accessor_set_field0(uintptr_t that,
                                                                                                          uintptr_t field0);

WireSyncRust2DartDco frbgen_lwk_dart_wire__crate__api__types__AssetIdMapUInt_auto_accessor_get_field0(uintptr_t that);

WireSyncRust2DartDco frbgen_lwk_dart_wire__crate__api__types__AssetIdMapUInt_auto_accessor_set_field0(uintptr_t that,
                                                                                                      uintptr_t field0);
...
void frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAssetIdBTreeMapInt(const void *ptr);

void frbgen_lwk_dart_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAssetIdBTreeMapInt(const void *ptr);

void frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAssetIdMapUInt(const void *ptr);

void frbgen_lwk_dart_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAssetIdMapUInt(const void *ptr);

void frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBTreeMapAssetIdi64(const void *ptr);

void frbgen_lwk_dart_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBTreeMapAssetIdi64(const void *ptr);

void frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBTreeMapAssetIdu64(const void *ptr);

void frbgen_lwk_dart_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBTreeMapAssetIdu64(const void *ptr);
...
static int64_t dummy_method_to_enforce_bundling(void) {
    ...
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAssetIdBTreeMapInt);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAssetIdMapUInt);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBTreeMapAssetIdi64);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBTreeMapAssetIdu64);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_Mutexlwk_wolletWollet);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAssetIdBTreeMapInt);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerAssetIdMapUInt);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBTreeMapAssetIdi64);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerBTreeMapAssetIdu64);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire__crate__api__descriptor__descriptor_new_confidential);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire__crate__api__types__AssetIdBTreeMapInt_auto_accessor_get_field0);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire__crate__api__types__AssetIdBTreeMapInt_auto_accessor_set_field0);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire__crate__api__types__AssetIdMapUInt_auto_accessor_get_field0);
    dummy_var ^= ((int64_t) (void*) frbgen_lwk_dart_wire__crate__api__types__AssetIdMapUInt_auto_accessor_set_field0);
